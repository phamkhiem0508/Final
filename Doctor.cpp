...
Doctor::Doctor(string name, string address, string phoneNumber, string speciality, string licenseNumber) : Person(name,
    ...
    if (licenseNumber.length() > 0) {
        this->salary = 500 * (licenseNumber[0]);
    }
}
...
//                line = id + "," + newDoctor.getName() + "," + newDoctor.getAddress() + "," + newDoctor.getPhoneNumber() + "," + newDoctor.getSpeciality()+","+newDoctor.getLicenseNumber()+","+to_string(newDoctor.getSalary());
//            }
